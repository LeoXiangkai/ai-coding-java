...
| 类型 | 典型输入 | 最小上下文 |
|---|---|---|
| feature | 新增功能、页面、接口、流程 | 需求、相关模块、接口/表/权限、验证矩阵；复杂需求再读 `docs/rd-integrated-workflow.md` |
| bugfix | 修复错误、数据异常、线上问题 | 复现证据、相关代码、回归测试、验证矩阵；复杂问题可补轻量设计和测试产物 |
| refactor | 重构、优化、拆分 | 目标边界、现有测试、兼容性约束；中高风险重构先写设计简报 |
